...
### 1. **Predictive Data Access in DPU-Accelerated Key–Value Stores**   
   - **Description**: The objective of this master’s thesis is to investigate, design, and implement an in-memory AI-based KV store on a DPU.
   - **Location**: University of Oslo (UiO) 
...
### 1. **Efficient Machine Learning Models for In-Network Traffic Classification**   
   - **Description**: In this thesis, we are investigating several types of neural network to be offloaded to the SmartNIC more efficient.
   - **Location**: University of Oslo (UiO) 
   - [Link](https://www.mn.uio.no/ifi/studier/masteroppgaver/nd/in-network-acceleration-of-distributed-in-memory-m.html)

### 2. **Experimenting PCIe interconnect**   
   - **Description**: In this thesis we are experimenting PCIe networks and evaluating in specific applications. 
   - **Location**: University of Oslo (UiO)
   - [Link](https://nva.sikt.no/registration/019c91462f97-142216d0-4261-41f0-a353-37f1832b3a32)
     
### 3. **Automating the TinyML Pipeline: From Model Compression to Edge Deployment**   
...
### 4. **A Simulated UAV System for Greenhouse Gas Emission Source Localization Using Dispersion Modeling**   
...
### 5. **Path Planning ML Models for Autonomous UAVs to detect hot spot**   
   - **Description**: In this thesis, we are modeling the path of a UAV to detect hot spot.
   - **Location**: University of Tromsø


### 6. **Architecting In-network memory access with FPGA-based SmartNIC for programmable data centers**   
...
### 7. **Evaluating BlueField-2 SmartNIC**   
...
### 8. **In-network monitoring of RDMA traffic**   
...
### 9. **Accelerating ResilientDB Fabric via RDMAs & SGX**   
...
### 10. Effect of CPU scheduling on power consumption
...
### 11. Change scheduling priority according to cache miss rate
...
### 12. Microsoft Azure InfiniBand Configuration
...
### 13. Fault injection on scheduler using FreeRTOS
