...
## 3. **Experimenting PCIe Interconnec**   
   ...
   - **Location**: University of Oslo (UiO)
   - 
## 3. **Energy Efficiency of TinyML inference on tiny devices**   
...
## 4. **Path Planning ML Models for Autonomous UAV**   
...
## 1. **Evaluating BlueField-2 SmartNIC**   
...
## 2. **In-network monitoring of RDMA traffic**   
...
## 3. **Accelerating ResilientDB Fabric via RDMAs & SGX, Shubham Pandey**   
...
## 4. Effect of CPU scheduling on power consumption
...
## 5. Change scheduling priority according to cache miss rate
 ...
 ## 6. Microsoft Azure InfiniBand Configuration
