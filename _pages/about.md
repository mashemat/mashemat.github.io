...
I am Masoud Hemmatpour, a researcher/engineer in computer science. I received my M.S. degree in Computer and Communication Network Engineering and my Ph.D. degree in Control and Computer Engineering from the [Politecnico di Torino](https://www.polito.it/), Italy, in 2015 and 2019, respectively.
...
<div style="
  ...
  margin: 30px auto;
">
  <img src="/assets/images/1.jpeg" alt="Photo 1" class="about-photo" />
  <img src="/assets/images/2.jpeg" alt="Photo 2" class="about-photo" />
  <img src="/assets/images/3.jpeg" alt="Photo 3" class="about-photo" />
  <img src="/assets/images/4.jpeg" alt="Photo 4" class="about-photo" />
  <img src="/assets/images/5.jpeg" alt="Photo 5" class="about-photo" />
...
<style>
  .about-photo {
    width: 100%;
    height: 220px;          /* SAME height for all photos */
    object-fit: cover;     /* Crops nicely without distortion */
    border-radius: 10px;   /* Optional: modern rounded corners */
  }
</style>
